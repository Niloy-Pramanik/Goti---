...
export default function AddOrgMemberModal({ isOpen, onClose, orgId }: AddOrgMemberModalProps) {
  ...
  const addMemberMutation = useMutation({
    mutationFn: async (data: { email: string; role: string }) => {
      const response = await apiClient.post(`/api/organizations/${orgId}/invitations`, data);
      ...
      >
        <div className="flex justify-between items-center p-6 border-b border-slate-100">
          <h2 className="text-xl font-bold text-slate-900">
            {inviteLink ? 'Invitation Link' : 'Invite Member'}
          </h2>
          <button 
            onClick={handleClose}
          ...
          <div className="p-6">
            ...
            <div className="bg-slate-50 rounded-xl p-4 mb-4">
              <p className="text-xs text-slate-500">
                ...
                When they click the link, they'll be prompted to register or login and automatically join your organization.
              </p>
            </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <select
                    ...
                    required
                  >
                    <option value="MEMBER">Member (Can view and access assigned teams)</option>
                    <option value="ADMIN">Admin (Can manage organization and all teams)</option>
                  </select>
                </div>
              </div>
            </div>
